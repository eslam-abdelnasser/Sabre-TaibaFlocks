 <!DOCTYPE html>
  ...
  <head>
      ...
      <link rel="apple-touch-icon" sizes="60x60" href="{{asset('admin-panel/assets/images/ico/apple-icon-60.png')}}">
      <link rel="apple-touch-icon" sizes="76x76" href="{{asset('admin-panel/assets/images/ico/apple-icon-76.png')}}">
      <link rel="apple-touch-icon" sizes="120x120" href="{{asset('admin-panel/assets/images/ico/apple-icon-120.png')}}">
      <link rel="apple-touch-icon" sizes="152x152" href="{{asset('admin-panel/assets/images/ico/apple-icon-152.png')}}">
      <link rel="shortcut icon" type="image/x-icon" href="{{asset('admin-panel/assets/images/ico/favicon.ico')}}">
      <link rel="shortcut icon" type="image/png" href="{{asset('admin-panel/assets/images/ico/favicon-32.png')}}">
      <meta name="apple-mobile-web-app-capable" content="yes">
      <meta name="apple-touch-fullscreen" content="yes">
      <meta name="apple-mobile-web-app-status-bar-style" content="default">
      <!-- BEGIN VENDOR CSS-->
        {{Html::style('admin-panel/assets/css/bootstrap.css')}}
      <!-- font icons-->
      {{Html::style('admin-panel/assets/fonts/icomoon.css')}}
      {{Html::style('admin-panel/assets/fonts/flag-icon-css/css/flag-icon.min.css')}}
      {{Html::style('admin-panel/assets/vendors/css/sliders/slick/slick.css')}}
      {{Html::style('admin-panel/assets/vendors/css/extensions/pace.css')}}
      {{Html::style('admin-panel/assets/vendors/css/charts/morris.css')}}
      {{Html::style('admin-panel/assets/vendors/css/extensions/unslider.css')}}
        {{Html::style('admin-panel/assets/vendors/css/weather-icons/climacons.min.css')}}
      <!-- END VENDOR CSS-->
      <!-- BEGIN ROBUST CSS-->
      {{Html::style('admin-panel/assets/css/bootstrap-extended.css')}}
      {{Html::style('admin-panel/assets/css/app.css')}}
        {{Html::style('admin-panel/assets/css/colors.css')}}
      <!-- END ROBUST CSS-->
         @yield('css')
      <!-- BEGIN Page Level CSS-->
      {{Html::style('admin-panel/assets/css/core/menu/menu-types/vertical-menu.css')}}
      {{Html::style('admin-panel/assets/css/core/colors/palette-gradient.css')}}
    {{Html::style('admin-panel/assets/css/plugins/calendars/clndr.css')}}




    <!-- dropzone css -->
    {{Html::style('admin-panel/assets/css/dropzone.css')}}


{{--     <link rel="stylesheet" type="text/css" href="../../../app-assets/vendors/css/forms/icheck/icheck.css">
    <link rel="stylesheet" type="text/css" href="../../../app-assets/vendors/css/forms/icheck/custom.css"> --}}

 {{Html::style('admin-panel/assets/vendors/css/forms/icheck/icheck.css')}}
 {{Html::style('admin-panel/assets/vendors/css/forms/icheck/custom.css')}}

      <!-- END Page Level CSS-->
      <!-- BEGIN Custom CSS-->
  {{Html::style('admin-panel/assets/assets/css/style.css')}}
      <!-- END Custom CSS-->
      ...
      <div class="navbar-wrapper">
          <div class="navbar-header">
              <ul class="nav navbar-nav">
                  ...
                  <li class="nav-item"><a href="index.html" class="navbar-brand nav-link"><img alt="branding logo" src="{{asset('admin-panel/assets/images/logo/robust-logo-light.png')}}" data-expand="{{asset('admin-panel/assets/images/logo/robust-logo-light.png')}}" data-collapse="{{asset('admin-panel/assets/images/logo/robust-logo-small.png')}}" class="brand-logo"></a></li>
                          ...
                          {{--<ul class="mega-dropdown-menu dropdown-menu row">--}}
                              {{--<li class="col-md-2">--}}
                                  ...
                                  {{--<div id="mega-menu-carousel-example" class="responsive-slick">--}}
                                      {{--<div><img src="{{asset('admin-panel/assets/images/slider/slider-2.png')}}" alt="First slide" class="rounded img-fluid mb-1"><a href="#" class="news-title mb-0">Poster Frame PSD</a>--}}
                                          {{--<p class="news-content"><span class="font-small-2">January 26, 2016</span></p>--}}
                                      {{--</div>--}}
                                      {{--<div><img src="{{asset('admin-panel/assets/images/slider/slider-5.png')}}" alt="First slide" class="rounded img-fluid mb-1"><a href="#" class="news-title mt-1 mb-0">Header MockUp</a>--}}
                                          {{--<p class="news-content"><span class="font-small-2">January 15, 2016</span></p>--}}
                                      {{--</div>--}}
                                      {{--<div><img src="{{asset('admin-panel/assets/images/slider/slider-6.png')}}" alt="First slide" class="rounded img-fluid mb-1"><a href="#" class="news-title mt-1 mb-0">2 Poster PSD</a>--}}
                                          {{--<p class="news-content"><span class="font-small-2">January 15, 2016</span></p>--}}
                                      {{--</div>--}}
                                  {{--</div>--}}
                              {{--</li>--}}
                  ...
                  {{--<ul class="nav navbar-nav float-xs-right">--}}
                      ...
                      {{--<li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-mail6"></i><span class="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>--}}
                          {{--<ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">--}}
                              ...
                              {{--<li class="list-group scrollable-container"><a href="javascript:void(0)" class="list-group-item">--}}
                                      {{--<div class="media">--}}
                                          {{--<div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{asset('admin-panel/assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span></div>--}}
                                          {{--<div class="media-body">--}}
                                      ...
                                      {{--</div></a><a href="javascript:void(0)" class="list-group-item">--}}
                                      {{--<div class="media">--}}
                                          {{--<div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="{{asset('admin-panel/assets/images/portrait/small/avatar-s-2.png')}}" alt="avatar"><i></i></span></div>--}}
                                          {{--<div class="media-body">--}}
                                      ...
                                      {{--</div></a><a href="javascript:void(0)" class="list-group-item">--}}
                                      {{--<div class="media">--}}
                                          {{--<div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{asset('admin-panel/assets/images/portrait/small/avatar-s-3.png')}}" alt="avatar"><i></i></span></div>--}}
                                          {{--<div class="media-body">--}}
                                      ...
                                      {{--</div></a><a href="javascript:void(0)" class="list-group-item">--}}
                                      {{--<div class="media">--}}
                                          {{--<div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="{{asset('admin-panel/assets/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span></div>--}}
                                          {{--<div class="media-body">--}}
                          ...
                          {{--</ul>--}}
                      {{--</li>--}}
                      {{--<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="{{asset('admin-panel/assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span><span class="user-name">John Doe</span></a>--}}
