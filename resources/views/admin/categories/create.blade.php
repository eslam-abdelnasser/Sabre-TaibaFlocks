        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-block">
                    <p>Fill <code>these fields</code> to add new category trip. </p>
                    ...
                    {!! Form::open(['route'=>['categories.store'],'method'=>'POST','class'=>'form-horizontal','role'=>'form','files'=>true]) !!}
                        ...
                        <div role="tabpanel" class="tab-pane {{$loop->first ? 'active' : ''}}" id="{{$language->label}}" aria-expanded="true" aria-labelledby="base-{{$language->label}}">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label for="timesheetinput1">Category Name ({{$language->name}})</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <textarea id="timesheetinput7" rows="5" class="form-control"  name="description_{{$language->label}}" placeholder="Description"></textarea>
