            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-block">
                        <p>Fill <code>these fields</code> to add new Option . </p>
                        ...
                        {!! Form::open(['route'=>['options.store'],'method'=>'POST','class'=>'form-horizontal','role'=>'form']) !!}
                        <div class="tab-content px-1 pt-1">
                                ...
                                <div role="tabpanel" class="tab-pane {{$loop->first ? 'active' : ''}}" id="{{$language->label}}" aria-expanded="true" aria-labelledby="base-{{$language->label}}">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label for="timesheetinput1">Option Name ({{$language->name}})</label>
                                            <div class="position-relative">
                                                <input type="text" id="timesheetinput1" value="{{old('name_'.$language->label)}}" class="form-control" placeholder="Option name" name="name_{{$language->label}}">
                            ...
                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        <input type="number" id="timesheetinput1" value="{{old('price')}}" class="form-control" placeholder="Price" name="price">
