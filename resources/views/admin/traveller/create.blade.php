...
@section('title' ,'Create Traveller History')
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add new Traveller history</h4>
                </div>
                <div class="card-body">
                    <div class="card-block">
                        <p>Fill <code>these fields</code> to add new Traveller History. </p>
                        ...
                        {!! Form::open(['route'=>['traveller.store'],'method'=>'POST','class'=>'form-horizontal','role'=>'form','files'=>true]) !!}
                                ...
                                <div role="tabpanel" class="tab-pane {{$loop->first ? 'active' : ''}}" id="{{$language->label}}" aria-expanded="true" aria-labelledby="base-{{$language->label}}">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label for="timesheetinput1">traveller title ({{$language->name}})</label>
                                        ...
                                        <div class="form-group">
                                            <label for="timesheetinput1">Traveller name ({{$language->name}})</label>
                                            <div class="position-relative">
                                                <input type="text" id="traveller_{{$language->label}}" value="{{old('traveller_'.$language->label)}}" class="form-control" placeholder="Traveller name" name="traveller_{{$language->label}}">
