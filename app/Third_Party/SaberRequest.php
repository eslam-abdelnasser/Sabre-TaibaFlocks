...
//            return $data ;
    ...
    public function airAvailability()
    {
...
//        }
        ...
        $xml = file_get_contents(storage_path('app/public/soapxml/OTA_AirAvailLLSRQ.xml'));
//        dd($xml);
...
//        $answer = $body;
        ...
        if (isset($answer->Errors->Error) && $answer->Errors->error == null)
        {
