...
//    public $projectUrlPath     = '/payfort-php-sdk';
    ...
    public function __construct()
    {
        ...
        $this->merchantIdentifier = Config::get('payment.merchant_identifier');
        $this->accessCode = Config::get('payment.access_code');
        $this->SHARequestPhrase = Config::get('payment.SHARequestPhrase');
        $this->SHAResponsePhrase = Config::get('payment.SHAResponsePhrase');
        $this->SHAType   = Config::get('payment.SHAType');
        $this->sandboxMode = Config::get('payment.sandbox_mode');
...
//        $this->amount = $amount ;
    ...
    {
        $merchantReference = $this->generateMerchantReference();
        $returnUrl = route('payfort-feedback');
    ...
    public function merchantPageNotifyFort($fortParams)
    {
        ...
        $postData      = array(
            ...
            'language'            => $this->language,
            'return_url'          => route('payfort-results'),
        );
